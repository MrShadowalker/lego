...
import com.lego.content.feign.ContentFeign;
import com.lego.content.pojo.Content;
import com.lego.item.feign.PageFeign;
...
public class MyEventListener {
 ...
 /*   @InsertListenPoint
   ...
   /* @DeleteListenPoint
    ...
    /*@ListenPoint(destination = "example", schema = "lego_content", table = {"tb_content"}, eventType = {CanalEntry.EventType.UPDATE,CanalEntry.EventType.INSERT,CanalEntry.EventType.DELETE})
